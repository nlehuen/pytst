...
MIDL_DEFINE_GUID(IID, IID_ITernarySearchTree,0x543BA9E0,0x60DF,0x42F8,0x9B,0xDA,0xC5,0x73,0xFB,0x4E,0xC0,0x91);
...
MIDL_DEFINE_GUID(CLSID, CLSID_CTernarySearchTree,0x01757CCD,0x8F45,0x498E,0xB8,0xBF,0x4E,0x4F,0x95,0xA0,0x7C,0xE7);

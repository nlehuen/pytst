...
public:
    textindex<wchar_t,_bstr_t,_bstr_t_reader_writer>::documents_score_map_pointer entries;

    void set_entries(textindex<wchar_t,_bstr_t,_bstr_t_reader_writer>::documents_score_map_pointer _entries);

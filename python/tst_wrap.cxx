...
SWIGINTERN PyObject *_wrap_delete_TSTCloseMatchIterator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_TSTIteratorT_match_iteratorT_char_PythonReference_memory_storageT_char_PythonReference_t_ObjectSerializer_string_type_t_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 { (char *)"new_TSTException", (PyCFunction)_wrap_new_TSTException, METH_O, (char *)"new_TSTException(char _message) -> TSTException"},
	 { (char *)"TSTException_what", (PyCFunction)_wrap_TSTException_what, METH_O, (char *)"TSTException_what(TSTException self) -> char"},
	 { (char *)"delete_TSTException", (PyCFunction)_wrap_delete_TSTException, METH_O, (char *)"delete_TSTException(TSTException self)"},
	 ...
	 { (char *)"new__TST", (PyCFunction)_wrap_new__TST, METH_NOARGS, (char *)"new__TST() -> _TST"},
	 { (char *)"delete__TST", (PyCFunction)_wrap_delete__TST, METH_O, (char *)"delete__TST(_TST self)"},
	 { (char *)"_TST_pack", (PyCFunction)_wrap__TST_pack, METH_O, (char *)"_TST_pack(_TST self)"},
	 ...
	 { (char *)"_TST_get_number_of_nodes", (PyCFunction)_wrap__TST_get_number_of_nodes, METH_O, (char *)"_TST_get_number_of_nodes(_TST self) -> int"},
	 { (char *)"_TST_get_default_value", (PyCFunction)_wrap__TST_get_default_value, METH_O, (char *)"_TST_get_default_value(_TST self) -> PythonReference"},
	 ...
	 { (char *)"delete__Action", (PyCFunction)_wrap_delete__Action, METH_O, (char *)"delete__Action(_Action self)"},
	 { (char *)"_Action_perform", _wrap__Action_perform, METH_VARARGS, (char *)"\n"
		...
		""},
	 { (char *)"_Action_result", (PyCFunction)_wrap__Action_result, METH_O, (char *)"_Action_result(_Action self) -> PythonReference"},
	 { (char *)"_Action_swigregister", _Action_swigregister, METH_VARARGS, NULL},
	 { (char *)"delete__Filter", (PyCFunction)_wrap_delete__Filter, METH_O, (char *)"delete__Filter(_Filter self)"},
	 ...
	 { (char *)"delete_CallableAction", (PyCFunction)_wrap_delete_CallableAction, METH_O, (char *)"delete_CallableAction(CallableAction self)"},
	 ...
	 { (char *)"new_CallableFilter", (PyCFunction)_wrap_new_CallableFilter, METH_O, (char *)"new_CallableFilter(PythonReference _callable) -> CallableFilter"},
	 { (char *)"delete_CallableFilter", (PyCFunction)_wrap_delete_CallableFilter, METH_O, (char *)"delete_CallableFilter(CallableFilter self)"},
	 ...
	 { (char *)"new_DictAction", (PyCFunction)_wrap_new_DictAction, METH_NOARGS, (char *)"new_DictAction() -> DictAction"},
	 { (char *)"delete_DictAction", (PyCFunction)_wrap_delete_DictAction, METH_O, (char *)"delete_DictAction(DictAction self)"},
	 ...
	 { (char *)"new_ListAction", (PyCFunction)_wrap_new_ListAction, METH_NOARGS, (char *)"new_ListAction() -> ListAction"},
	 { (char *)"delete_ListAction", (PyCFunction)_wrap_delete_ListAction, METH_O, (char *)"delete_ListAction(ListAction self)"},
	 ...
	 { (char *)"new_TupleListAction", (PyCFunction)_wrap_new_TupleListAction, METH_NOARGS, (char *)"new_TupleListAction() -> TupleListAction"},
	 { (char *)"delete_TupleListAction", (PyCFunction)_wrap_delete_TupleListAction, METH_O, (char *)"delete_TupleListAction(TupleListAction self)"},
	 ...
	 { (char *)"new_ObjectSerializer", (PyCFunction)_wrap_new_ObjectSerializer, METH_NOARGS, (char *)"new_ObjectSerializer() -> ObjectSerializer"},
	 ...
	 { (char *)"delete_ObjectSerializer", (PyCFunction)_wrap_delete_ObjectSerializer, METH_O, (char *)"delete_ObjectSerializer(ObjectSerializer self)"},
	 ...
	 { (char *)"new_TST", (PyCFunction)_wrap_new_TST, METH_NOARGS, (char *)"new_TST() -> TST"},
	 { (char *)"delete_TST", (PyCFunction)_wrap_delete_TST, METH_O, (char *)"delete_TST(TST self)"},
...
static void *_p_CallableFilterTo_p_tst_filterT_char_PythonReference_string_type_t(void *x, int *newmemory) {
    return (void *)((tst_filter< char,PythonReference,string_type > *)  ((CallableFilter *) x));
}
static void *_p_DictActionTo_p_tst_actionT_char_PythonReference_string_type_t(void *x, int *newmemory) {
    return (void *)((tst_action< char,PythonReference,string_type > *)  ((DictAction *) x));
}
static void *_p_ListActionTo_p_tst_actionT_char_PythonReference_string_type_t(void *x, int *newmemory) {
    return (void *)((tst_action< char,PythonReference,string_type > *)  ((ListAction *) x));
}
static void *_p_TupleListActionTo_p_tst_actionT_char_PythonReference_string_type_t(void *x, int *newmemory) {
    return (void *)((tst_action< char,PythonReference,string_type > *)  ((TupleListAction *) x));
}
static void *_p_CallableActionTo_p_tst_actionT_char_PythonReference_string_type_t(void *x, int *newmemory) {
    return (void *)((tst_action< char,PythonReference,string_type > *)  ((CallableAction *) x));
}
static void *_p_TSTTo_p_tstT_char_PythonReference_memory_storageT_char_PythonReference_t_ObjectSerializer_string_type_t(void *x, int *newmemory) {
